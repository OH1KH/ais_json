...
CREATE TABLE `nmea` (
  ...
  `lon` varchar(28) NOT NULL,
  `lat` varchar(27) NOT NULL,
  `speed` varchar(20) NOT NULL,
  `course` varchar(12) NOT NULL,
  `heading` varchar(9) NOT NULL,
  `status` varchar(4) NOT NULL,
  `shiptype` varchar(8) NOT NULL,
  `partno` varchar(2) NOT NULL,
  `callsign` varchar(42) NOT NULL,
  `shipname` varchar(120) NOT NULL,
  `vendorid` varchar(18) NOT NULL,
  `ref_front` varchar(9) NOT NULL,
  `ref_left` varchar(9) NOT NULL,
  `draught` varchar(8) NOT NULL,
  `length` varchar(9) NOT NULL,
  `width` varchar(9) NOT NULL,
  `destination` varchar(120) NOT NULL,
  `persons_on_board` varchar(14) NOT NULL,
  PRIMARY KEY (`id`)
